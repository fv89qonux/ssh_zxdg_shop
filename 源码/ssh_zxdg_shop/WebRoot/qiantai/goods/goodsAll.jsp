...
<div id="MainCenter" align="center" class="MainCenter">
		 ...
		 <div id="content" class="Sub">
				<div class="NewContainer771">
					<div class="BoxHeader">
						<div class="BoxHeader-center MarginTop10">蛋糕信息</div>
					</div>
					<div class="Slot" style="height: 100%">
						<table width="99%" border="0" cellpadding="2" cellspacing="8" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
				              <tr align="'left'" bgcolor="#FAFAF1" height="22">
								  ...
								  <tr align='left' bgcolor="#FFFFFF" height="22">
									  ...
									  <td><a href="<%=path %>/goodsDetailQian.action?goodsId=<s:property value="#goods.goodsId"/>">详细信息</a></td>
								  </tr>
								  </s:iterator>
	        			</table>
                    </div>
