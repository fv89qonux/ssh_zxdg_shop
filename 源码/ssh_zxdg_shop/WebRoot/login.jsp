...
<html>
	...
	<body>
		<div id="Layer1" style="position: absolute; left: 417px; top: 203px; width: 360px; height: 131px; z-index: 1;">
			<form action="" name="ThisForm" method="post">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="100%" colspan="2" align="left">
							<font style="font-size: 33px;color: white;font-weight: bolder;display: block;text-align: left">
							    &nbsp;后台登录
				            </font>
						</td>
					</tr>
					...
					<tr>
						<td width="15%" height="22">
							<span style="font-size: 12px;color: white;">用户名:</span>
						</td>
					...
					<tr>
						<td width="15%" height="22">
							<span style="font-size: 12px;color: white;">密&nbsp;&nbsp;&nbsp;&nbsp;码:</span>
						</td>
						<td width="85%" height="22">
